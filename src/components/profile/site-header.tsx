...
/** Page order — the order links appear in when they fit. */
const NAV_ITEMS = [
...
/**
 * Importance order — on narrow screens the header keeps as many of these
 * as fit, starting from the front, and drops the rest.
 */
const NAV_PRIORITY = [
  "#about",
  "#experience",
